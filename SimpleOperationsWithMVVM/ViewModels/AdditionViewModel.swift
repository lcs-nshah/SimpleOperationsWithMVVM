...
class AdditionViewModel {
    ...
    var addition: Addition? {
        ...
        // Check that the string in providedFirstAddend can be converted into Int
        guard let firstAddend = Int(providedFirstAddend) else {
            recoverySuggestion = "Please enter an integer for the first addend"
            
            return nil
        }
        
        // Check that the string in providedSecondAddend can be converted into Int
        guard let secondAddend = Int(providedSecondAddend) else {
            recoverySuggestion = "Please enter an integer for the second addend"
